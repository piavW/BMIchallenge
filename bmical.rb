#bmival = kgWeight/meterHeight*meterHeight;
...
module BMICalculator
    def self.metric_bmi(object)
        weight = object.weight.to_f #makes it a float
        height = object.weight.to_f
    ...
    def self.set_bmi_message(object)
        ...
        elsif object.bmi_value >= 18.5 && object.bmi_value <= 24.9
            object.bmi_message = "Healthy"
        elsif object.bmi_value >= 25 && object.bmi_value <= 29.9
